...
\newcommand{\revref}[1]{\marginnote{\textcolor{purple}{$EC_{#1}$}}}
\newcommand{\annref}[1]{\marginnote{\textcolor{purple}{$AC_{#1}$}}}
\newcommand{\selfref}[1]{\marginnote{\textcolor{purple}{$SC_{#1}$}}}
