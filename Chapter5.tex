...
\begin{table}[h!]
    ...
    \begin{tabular}{|ccc|cccc|}
        ...
        & & & (\%) & (\%) & ($cm^{-1}$) & (a.u.) \\
        \hline
        \multirow{8}{*}{\shortstack{Hyper-\\vascularised}} & \multirow{4}{*}{Y} & 1 & 84.0 (20.3) & 2.39 (2.08) & 48.9 (28.9) & 1.72 (1.24) \\
        ...
        \cline{2-7}
        & \multirow{4}{*}{J} & 1 & 78.0 (20.8) & 6.64 (10.7) & 25.9 (27.2) & 1.76 (1.27) \\
        ...
        \hline
        \multirow{8}{*}{Normal} & \multirow{4}{*}{Y} & 1 & 81.9 (22.7) & 0.782 (0.428) & 8.33 (1.85) & 0.318 (0.799) \\
        ...
        \cline{2-7}
        & \multirow{4}{*}{J} & 1 & 84.0 (22.1) & 0.933 (0.701) & 8.46 (2.27) & 0.311 (0.798) \\
